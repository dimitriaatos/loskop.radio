<template>
	<Layout>
		<div class="container">
			<div class="description" v-html="$page.directus.items.about.description" />
				...
				<div class="contact">
					...
					<div class="social">
						...
						<a
							:href="mixcloud"
							target="_blank"
							class="button mixcloud"
						>Mixcloud</a>
					</div>
					<div class="credits">
						<!-- Copyright © 2021, LOSKOP.radio <br> -->
						Developed by <g-link :to="`https://dimitriaatos.info`">
...
const subRequest = async (body) => await fetch(
	'/subscribe',
...
export default {
	...
	methods: {
		async subscribe(event){
			...
			try {
				await subRequest(this.email)
				this.subStatus = 'DONE!'
				// sessionStorage.setItem('sub', 'DONE!')
			} catch {
